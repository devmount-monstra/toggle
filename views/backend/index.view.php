...
<div class="row">
    <div class="col-md-6">
        <?php
            echo (
                Form::label('toggle_duration', __('Slide duration', 'toggle')) .
    ...
    <div class="col-md-6">
        <?php
            echo (
                ...
                Form::input('toggle_easing', Option::get('toggle_easing'), array('class' => 'form-control')) .
...
<?php
    echo (
        Form::submit('toggle_save', __('Save', 'toggle'), array('class' => 'btn')) .
        Form::close()
    );
?>